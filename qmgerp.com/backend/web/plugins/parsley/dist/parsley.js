...
// eg: `data-parsley-stop-on-first-failing-constraint="false"`
  ...
  ParsleyAbstract.prototype = {
    ...
    reset: function () {
      ...
      // model case: emit a reset event for each field
    ...
    destroy: function () {
      ...
      // model case: destroy all its fields and then destroy stored instance
      for (var i = 0; i < this.fields.length; i++)
  ...
  */
  var Violation = function ( assert, value, violation ) {
    ...
    if ( ! ( assert instanceof Assert ) )
      throw new Error( 'Should give an assertion implementing the Assert interfaces' );
    this.assert = assert;
    this.value = value;
  ...
  */
  ...
  ParsleyField.prototype = {
    ...
    */
    ...
    // # Internals
    // Internal only.
    // Bind constraints from customer-config + options + DOM
  ...
  $.emit = function (name, instance) {
    ...
    for (var i = 0; i < subscribed[name].length; i++) {
      ...
      // if registered instance is a model and fired one is a Field, loop over all its fields and emit if field found
...
window.ParsleyConfig.i18n.en = $.extend(window.ParsleyConfig.i18n.en || {}, {
  ...
  type: {
    ...
    number:       "不可以酱紫，这里必须填写数字哦~~~",
    integer:      "This value should be a valid integer.",
    digits:       "This value should be digits.",
    alphanum:     "This value should be alphanumeric."
  },
  notblank:       "This value should not be blank.",
  required:       "亲，这里是必须要填的哦~~~~~",
