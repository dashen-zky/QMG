...
?>
<?= Html::beginForm(['/statistic/sales-statistic/anniversary-achievement-list-filter'], 'post', ['data-pjax' => '', 'class' => 'ListFilterForm']); ?>
    <table class="table">
        <tbody>
        <tr>
            ...
            <td class="col-md-3">
                <div class="col-md-12">
                    <?= Html::input('text', 'ListFilterForm[sales_name]',
