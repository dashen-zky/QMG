...
class ProjectBrief extends BaseRecord implements DeleteRecordOperator
{
    ...
    public function formDataPreHandler(&$formData, $record)
    {
        ...
        if (empty($record)) {
            $formData['status'] = ProjectBriefConfig::StatusApplying;
        }

        $this->handlerFormDataTime($formData, 'proposal_time');
        $this->handlerFormDataTime($formData, 'done_time');
    }
    ...
    public function insertRecord($formData)
    {
        ...
        try {
            UploadFileHelper::uploadWhileInsert($this,
                ...
                '/upload/project_brief/'.$formData['uuid']);
            $this->insert();
        } catch (Exception $e) {
