...
class HTMLPurifier_Printer_ConfigForm extends HTMLPurifier_Printer
{
    ...
    /**
     * Name of form element to stuff customer-config in.
     * @type string
     */
    protected $name;
    ...
    /**
     * @param string $name model element name for directives to be stuffed into
    ...
    public function render($config, $allowed = true, $render_controls = true)
    {
        ...
        $ret = '';
        $ret .= $this->start('table', array('class' => 'hp-customer-config'));
