...
class HTMLPurifier_Config
{
    ...
    /**
     * Whether or not customer-config is finalized.
     * @type bool
     */
    ...
    /**
     * Convenience constructor that creates a customer-config object based on a mixed var
     * @param mixed $config Variable that defines the state of the customer-config
    ...
    /**
     * Creates a new customer-config object that inherits from a previous one.
     * @param HTMLPurifier_Config $config Configuration object to inherit from.
     * @return HTMLPurifier_Config object with $customer-config as its parent.
     */
    ...
    public function get($key, $a = null)
    {
        if ($a !== null) {
            $this->triggerError(
                "Using deprecated API: use \$customer-config->get('$key.$a') instead",
                E_USER_WARNING
            );
            $key = "$key.$a";
        }
    ...
    public function set($key, $value, $a = null)
    {
        if (strpos($key, '.') === false) {
            ...
            $value = $a;
            $key = "$key.$directive";
            $this->triggerError("Using deprecated API: use \$customer-config->set('$key', ...) instead", E_USER_NOTICE);
        } else {
     ...
     * @param string|bool $index Index/name that the customer-config variables are in
