 ...
 * a convenient web-interfaces for editing the most common HTML Purifier
 * configuration directives. You can also specify custom configuration
 * by creating a 'customer-config.php' file.
 */
...
if (isset($_POST['reset'])) {
    unset($PHORUM['mod_htmlpurifier']['customer-config']);
}
