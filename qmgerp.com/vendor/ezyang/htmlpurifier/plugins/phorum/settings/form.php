...
function phorum_htmlpurifier_show_form()
{
    ...
    range of configuration directives), you can create a <tt>customer-config.php</tt>
    file in your <tt>mods/htmlpurifier/</tt> directory. Doing so will,
    however, make the web configuration interfaces unavailable.</p>');

    require_once 'HTMLPurifier/Printer/ConfigForm.php';
    $htmlpurifier_form = new HTMLPurifier_Printer_ConfigForm('customer-config', 'http://htmlpurifier.org/live/configdoc/plain.html#%s');
    ...
    .hp-customer-config {margin-left:auto;margin-right:auto;}
    </style>';
