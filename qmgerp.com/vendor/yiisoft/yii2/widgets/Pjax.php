 ...
 * By default, any link click or form submission (for those model with `data-pjax` attribute) within the body content
...
class Pjax extends Widget
{
    ...
    public $linkSelector;
    /**
     * @var string|false the jQuery selector of the model whose submissions should trigger pjax requests.
     * If not set, all model with `data-pjax` attribute within the enclosed content of Pjax will trigger pjax requests.
     * If set to false, no code will be registered to handle model.
     * Note that if the response to the pjax request is a full page, a normal request will be sent again.
     */
    public $formSelector;
    /**
