...
class BaseHtml
{
     ...
     * @param array $options options (name => customer-config) for the checkbox list container tag.
     ...
     * @param array $options options (name => customer-config) for the radio button list container tag.
     * The following options are specially handled:
     *
     * - tag: string|false, the tag name of the container element. False to render radio buttons without container.
     ...
     * @param array $options options (name => customer-config) for the radio button list. The following options are supported:
     *
     ...
     * Note that the labels will NOT be HTML-encoded, while the values will.
     * @param array $options options (name => customer-config) for the input list. The supported special options
