...
class BaseUrl
{
     ...
     *
     * ```php
     * // generates: /index.back.php?r=site/index&param1=value1&param2=value2
     ...
     *
     * ```php
     * // generates: /index.back.php?r=site/index&param1=value1#name
     ...
     *
     * ```php
     * // /index.back.php?r=site%2Findex
     * echo Url::toRoute('site/index');
     *
     * // /index.back.php?r=site%2Findex&src=ref1#name
     * echo Url::toRoute(['site/index', 'src' => 'ref1', '#' => 'name']);
     *
     * // http://www.example.com/index.back.php?r=site%2Findex
     * echo Url::toRoute('site/index', true);
     *
     * // https://www.example.com/index.back.php?r=site%2Findex
     * echo Url::toRoute('site/index', 'https');
     *
     * // /index.back.php?r=post%2Findex     assume the alias "@posts" is defined as "post/index"
     ...
     *
     * // /index.back.php?r=post%2Fview&id=123&src=google
     * echo Url::current();
     *
     * // /index.back.php?r=post%2Fview&id=123
     * echo Url::current(['src' => null]);
     *
     * // /index.back.php?r=post%2Fview&id=100&src=google
