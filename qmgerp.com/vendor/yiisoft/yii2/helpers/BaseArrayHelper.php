...
class BaseArrayHelper
{
     ...
     * but additionally works for objects that implement the [[\Traversable]] interfaces.
     ...
     * but additionally works on objects that implement the [[\Traversable]] interfaces.
