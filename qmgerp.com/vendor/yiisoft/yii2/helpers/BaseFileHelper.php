...
class BaseFileHelper
{
     ...
     *   For example, "views/*.php" matches "views/index.back.php" but not "views/controller/index.back.php".
     *   A leading slash matches the beginning of the pathname. For example, "/*.php" matches "index.back.php" but not "views/start/index.back.php".
