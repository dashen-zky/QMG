...
/**
 * ActiveQueryInterface defines the common interfaces to be implemented by active record query classes.
 *
 ...
 * records only.
 *
 * A class implementing this interfaces should also use [[ActiveQueryTrait]] and [[ActiveRelationTrait]].
 *
