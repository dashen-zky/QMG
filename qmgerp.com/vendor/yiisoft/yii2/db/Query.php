...
class Query extends Component implements QueryInterface
{
     ...
     * This method will return a [[BatchQueryResult]] object which implements the [[\Iterator]] interfaces
     ...
     * @return BatchQueryResult the batch query result. It implements the [[\Iterator]] interfaces
     * and can be traversed to retrieve the data in batches.
     */
