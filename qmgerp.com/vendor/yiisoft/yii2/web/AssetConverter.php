...
{
    /**
     * @var array the commands that are used to perform the assets conversion.
     * The keys are the assets file extension names, and the values are the corresponding
    ...
    /**
     * @var boolean whether the source assets file should be converted even if its result already exists.
    ...
    /**
     * Runs a command to convert assets files.
     * @param string $command the command to run. If prefixed with an `@` it will be treated as a path alias.
     * @param string $basePath assets base path and command working directory
     * @param string $asset the name of the assets file
