 ...
 * This class allows rendering of the check report for the web and console application hrinterfaces.
 *
 * Example:
 *
 * ```php
...
class YiiRequirementChecker
{
    ...
    function render()
    {
        ...
        if (!empty($_SERVER['argv'])) {
            $viewFileName = $baseViewFilePath . DIRECTORY_SEPARATOR . 'console' . DIRECTORY_SEPARATOR . 'index.back.php';
        } else {
            $viewFileName = $baseViewFilePath . DIRECTORY_SEPARATOR . 'web' . DIRECTORY_SEPARATOR . 'index.back.php';
        }
