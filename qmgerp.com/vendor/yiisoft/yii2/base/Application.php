 ...
 *
 * @property \yii\web\AssetManager $assetManager The assets manager application component. This property is
 * read-only.
...
abstract class Application extends Module
{
     ...
     *
     * If not set explicitly in the application customer-config, this property will be populated with the contents of
     ...
     * @param array $config application customer-config
     */
     ...
     * If time zone is not configured in php.ini or application customer-config,
    ...
    /**
     * Returns the assets manager.
     * @return \yii\web\AssetManager the assets manager application component.
     */
