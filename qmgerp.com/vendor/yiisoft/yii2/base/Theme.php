 ...
 * then the themed version for a view file `@app/views/site/index.back.php` will be
 * `@app/themes/basic/site/index.back.php`.
 *
 ...
 * ```
 *
 * In this case, the themed version could be either `@app/themes/christmas/site/index.back.php` or
 * `@app/themes/basic/site/index.back.php`. The former has precedence over the latter if both files exist.
 *
