...
class Model extends Component implements IteratorAggregate, ArrayAccess, Arrayable
{
     ...
     *
     * The purpose of the above naming schema is that for model which contain multiple different models,
     * the attributes of each model are grouped in sub-arrays of the POST-data and it is easier to
     * differentiate between them.
     *
     * By default, this method returns the model class name (without the namespace part)
     * as the form name. You may override it when the model is used in different model.
     *
     ...
     * This method is required by the interfaces [[\IteratorAggregate]].
     ...
     * This method is required by the SPL interfaces [[\ArrayAccess]].
