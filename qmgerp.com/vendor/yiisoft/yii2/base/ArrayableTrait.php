...
/**
 * ArrayableTrait provides a common implementation of the [[Arrayable]] interfaces.
 *
...
trait ArrayableTrait
{
     ...
     *
     * If the model implements the [[Linkable]] interfaces, the resulting array will also have a `_link` element
     * which refers to a list of links as specified by the interfaces.
     *
