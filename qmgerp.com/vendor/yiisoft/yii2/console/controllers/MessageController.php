 ...
 * setting in customer-config file:
 *
 ...
 *
 * Usage:
 * 1. Create a configuration file using the 'message/customer-config' command:
 *    yii message/customer-config /path/to/myapp/messages/customer-config.php
 * 2. Edit the created customer-config file, adjusting it for your web application needs.
 * 3. Run the 'message/extract' command, using created customer-config:
 *    yii message /path/to/myapp/messages/customer-config.php
 *
...
EOD;
     ...
     * You may use the "yii message/customer-config" command to generate
 ...
 *
 * Message string can be used with plural model format. Check i18n section
