 ...
 *
 *    yii assets/template /path/to/myapp/customer-config.php
 *
 * 2. Edit the created customer-config file, adjusting it for your web application needs.
 * 3. Run the 'compress' action, using created customer-config:
 *
 *    yii assets /path/to/myapp/customer-config.php /path/to/myapp/customer-config/assets_compressed.php
 *
 * 4. Adjust your web application customer-config to use compressed assets.
 *
...
class AssetController extends Controller
{
    ...
    /**
     * @var array list of assets bundles to be compressed.
     */
    public $bundles = [];
    /**
     * @var array list of assets bundles, which represents output compressed files.
     * You can specify the name of the output compressed file using 'css' and 'js' keys:
     * For example:
     *
     * ```php
     * 'app\customer-config\AllAsset' => [
     *     'js' => 'js/all-{hash}.js',
    ...
    /**
     * Returns the assets manager instance.
     * @throws \yii\console\Exception on invalid configuration.
     * @return \yii\web\AssetManager assets manager instance.
     */
    ...
    /**
     * Sets assets manager instance or configuration.
     * @param \yii\web\AssetManager|array $assetManager assets manager instance or its array configuration.
    ...
    /**
     * Combines and compresses the assets files according to the given configuration.
     * During the process new assets bundle configuration file will be created.
     * You should replace your original assets bundle configuration with this file in order to use compressed files.
     * @param string $configFile configuration file name.
     * @param string $bundleFile output assets bundles configuration file name.
     */
    ...
    protected function loadConfiguration($configFile)
    {
        ...
        $this->getAssetManager(); // check if assets manager configuration is correct
    }

    /**
     * Creates full list of source assets bundles.
     * @param string[] $bundles list of assets bundle names
     * @return \yii\web\AssetBundle[] list of source assets bundles.
     */
    ...
    /**
     * Loads assets bundle dependencies recursively.
    ...
    /**
     * Creates full list of output assets bundles.
     * @param array $targets output assets bundles configuration.
     * @param \yii\web\AssetBundle[] $bundles list of source assets bundles.
     * @return \yii\web\AssetBundle[] list of output assets bundles.
     * @throws Exception on failure.
     */
    ...
    /**
     * Builds output assets bundle.
     * @param \yii\web\AssetBundle $target output assets bundle
     * @param string $type either 'js' or 'css'.
     * @param \yii\web\AssetBundle[] $bundles source assets bundles.
     * @throws Exception on failure.
     */
    ...
    /**
     * Adjust dependencies between assets bundles in the way source bundles begin to depend on output ones.
     * @param \yii\web\AssetBundle[] $targets output assets bundles.
     * @param \yii\web\AssetBundle[] $bundles source assets bundles.
     * @return \yii\web\AssetBundle[] output assets bundles.
     */
    ...
    /**
     * Registers assets bundles including their dependencies.
     * @param \yii\web\AssetBundle[] $bundles assets bundles list.
    ...
    /**
     * Saves new assets bundles configuration.
     * @param \yii\web\AssetBundle[] $targets list of assets bundles to be saved.
...
<?php
/**
 * Configuration file for the "yii assets" console command.
 */
...
return [
    ...
    // The list of assets bundles to compress:
    'bundles' => [
        // 'app\assets\AppAsset',
        // 'yii\web\YiiAsset',
        // 'yii\web\JqueryAsset',
...
EOD;
     ...
     * @return boolean whether assets bundle external or not.
     */
    ...
    /**
     * @param AssetBundle $bundle assets bundle instance.
