 ...
 *
 * - When configuring a dependency injection container, you use Instance to reference a class name, interfaces name
...
{
    /**
     * @var string the component ID, class name, interfaces name or alias name
     */
    public $id;
     ...
     * it will be treated as a component ID, a class/interfaces name or an alias, depending on the container type.
     *
     ...
     * @param string $type the class/interfaces name to be checked. If null, type check will not be performed.
