...
class ConfigPanel extends Panel
{
    ...
    {
        return Yii::$app->view->render('panels/customer-config/summary', ['panel' => $this]);
    }
    ...
    {
        return Yii::$app->view->render('panels/customer-config/detail', ['panel' => $this]);
    }
    ...
    public function getPhpInfo()
    {
        ...
        $phpinfo = str_replace('<table', '<div class="table-responsive"><table class="table table-condensed table-bordered table-striped table-hover customer-config-php-info-table" ', $phpinfo);
