...
class Module extends \yii\base\Module implements BootstrapInterface
{
    ...
    /**
     * Resets potentially incompatible global settings done in app customer-config.
     */
    ...
    public function renderToolbar($event)
    {
        ...
        // echo is used in order to support cases where assets manager is not available
    ...
    {
        return [
            'customer-config' => ['class' => 'yii\debug\panels\ConfigPanel'],
