 ...
 *
 * PHP SOAP extension is required.(simple object access Protocol) 简单对象访问协议
 ...
 *
 * @property string $methodName The currently requested method name.
 * Empty if no method is being requested.
 *
...
class WebService extends \yii\base\Component
{
     ...
     * This is required by {@link generateWsdl()} and {@link renderWsdl()}.
     */
    public $serviceUrl;
    /**
    ...
    /**
     * A list of classes that are declared as complex（复杂的，合成的） types in WSDL.
